...
public class ProductController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<Object> getProductById(@PathVariable("id") Long productId) throws Exception{
	...
	@PutMapping("/update/{pId}/{quantity}")
	public ResponseEntity<Object> updateQuantity(@PathVariable("pId") Long productId,@PathVariable("quantity") Long quantity){
		
		return productService.getUpdateQuantity(productId,quantity);
	}
